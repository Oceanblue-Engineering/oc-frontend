...
export const CreditOrders: React.FC = () => {
  ...
  const handleOpenPaidAmountModal = (order: Order) => {
    ...
    setNewPaidAmount(String(order.paidAmount ?? ""));
                ...
                <div className="bg-slate-50 rounded-lg p-4 mb-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-slate-800">
                        {typeof orderToDelete.creditPersonId === "object"
                          ? orderToDelete.creditPersonId?.name || "No customer assigned"
                          : orderToDelete.creditPersonId || "No customer assigned"}
                      </span>
                    </div>
                  </div>
                </div>
