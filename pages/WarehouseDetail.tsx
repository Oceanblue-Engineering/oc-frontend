  ...
  return (
    <div className="p-4 sm:p-6">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-800 flex items-center gap-2 flex-wrap">
              ...
              {warehouseCode && (
                <span className="text-xs sm:text-sm px-2 py-1 bg-primary/20 text-zinc-700 rounded-full font-medium flex-shrink-0">
                  {warehouseCode}
                </span>
              )}
            </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-xl shadow-sm border border-ocean-100 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="p-2 bg-ocean-100 rounded-lg">
              <Package className="w-4 h-4 sm:w-5 sm:h-5 text-ocean-600" />
            </div>
            <div className="min-w-0">
