    ...
    <>
      <div className="bg-white rounded-2xl border border-slate-100 p-4 sm:p-6 shadow-sm">
        <h3 className="text-base font-semibold text-slate-800 mb-4 flex items-center gap-2">
          <ImagePlus className="w-5 h-5 text-[#27272a]" />
          {t("settings.shopLogo")}
        </h3>
          ...
          <div className="flex-1 min-w-0 space-y-3">
            ...
            <>
              <input
                ...
                disabled={isBusy}
                className="block w-full text-sm text-slate-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-ocean-50/70 file:text-[#27272a] hover:file:bg-ocean-100/80 disabled:opacity-50 cursor-pointer"
              />
