      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="border border-slate-200 rounded-lg px-3 py-2 text-sm bg-white focus:ring-2 focus:ring-ocean-500 focus:border-ocean-500 outline-none w-full sm:w-48"
          />
        </div>
        ...
        <div className="flex items-center justify-between py-2">
          ...
          <button
            ...
            className={`relative w-12 h-6 rounded-full transition-colors ${
              enabled ? "bg-ocean-500" : "bg-slate-300"
            }`}
          >
            <span
