      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4 w-full">
        ...
        <div className="relative flex-1 min-w-[200px] sm:min-w-[250px]">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 border border-gray-200/80 rounded-full focus:ring-2 focus:ring-ocean-500 focus:border-ocean-500 outline-none text-xs sm:text-sm text-slate-700"
            value={search}
